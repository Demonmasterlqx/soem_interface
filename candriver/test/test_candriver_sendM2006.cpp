...
int main(){
    ...
    send_frame2.can_id = 0x200;
    send_frame1.can_dlc = 8;
    send_frame2.can_dlc = 8;

    send_frame1.data[2] = 0x17;
    send_frame1.data[3] = 0x77;
    // send_frame2.data[6] = 0x10;
    // send_frame2.data[7] = 0x00;
    // send_frame2.data[0] = 0x10;
    // send_frame2.data[1] = 0x10;
